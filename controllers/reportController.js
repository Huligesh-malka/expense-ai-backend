    ...
    try {
        ...
        const [[purchases]] = await db.query(
            ...
            SELECT
                ...
                IFNULL(SUM(total_amount), 0) AS purchase_amount,
        ...
        res.json({
            ...
            data: {
                ...
                purchases: {
                    ...
                    purchase_amount: Number(purchases.purchase_amount || 0),
                    paid_amount: Number(purchases.paid_amount || 0),
                    due_amount: Number(purchases.due_amount || 0)
                }
            }
        });
...
exports.getSalesReport = async (req, res) => {
    try {
        ...
        const paymentParams = [businessId];
    ...
    try {
        ...
        const data = rows.map(row => {
            ...
            return {
                ...
                sales_value: Number(salesValue.toFixed(2)),
    ...
    try {
        ...
        const [rows] = await db.query(
            ...
            SELECT
                ...
                (stock * purchase_price) AS stock_value,
        ...
        rows.forEach(row => {
            ...
            inventoryValue += Number(row.stock_value || 0);
